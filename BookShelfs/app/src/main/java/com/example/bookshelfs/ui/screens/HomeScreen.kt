...
import com.example.bookshelfs.model.model1.ImageLinks
import com.example.booksphotos.R
import com.example.bookshelfs.model.model1.VolumeInfo
import com.example.bookshelfs.ui.theme.BookShelfsTheme
...
fun HomeScreen(
    ...
    when (booksUiState) {
        ...
        is BooksUiState.Success -> PhotosGridScreen(
            booksUiState.photos, modifier = modifier.fillMaxWidth()
        )
...
@Composable
fun PhotosGridScreen(photos: List<VolumeInfo>, modifier: Modifier = Modifier) {
    LazyVerticalGrid(
...
fun PhotosGridScreenPreview() {
    BookShelfsTheme {
        val mockData = List(10) { VolumeInfo("title", "authors") }
